...
location_table: Dict[str, AWLocationData] = {
    ...
    lname.fruit_49.value: AWLocationData(1049, ByteSect.fruits, 49, ["Fruits"], AWTracker(130, 0, 0, 0, 31)),
    lname.fruit_50.value: AWLocationData(1050, ByteSect.fruits, 50, ["Fruits"], AWTracker(174, 0, 0, 0, 16)),
    ...
    lname.fruit_56.value: AWLocationData(1056, ByteSect.fruits, 56, ["Fruits"], AWTracker(130, 0, 0, 0, 36)),
    lname.fruit_57.value: AWLocationData(1057, ByteSect.fruits, 57, ["Fruits"], AWTracker(174, 0, 0, 0, 18)),
